...
import github_b from "../assets/github_black.png";
// import github_w from "../assets/github_white.png";
import insta_b from "../assets/instagram_black.png";
// import insta_w from "../assets/instagram_white.png";
import in_b from "../assets/linkedin_black.png";
// import in_w from "../assets/linkedin_white.png";
import up_b from "../assets/upwork_black.png";
...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-[#C4C4C4] pt-8 pb-6 mt-10">
        ...
        <div className="flex w-full items-center xl:flex-row justify-center flex-col xl:w-[80%] m-auto flex-wrap xl:justify-between text-left lg:text-left">
          <div className="xl:w-1/2 w-full px-4">
            ...
            <div className="mt-6 lg:mb-0 mb-6">
              <button className="bg-white text-sky-100 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2">
