...
export default function Home() {
  ...
  return (
    <div>
      <div
        className={`md:bg-[#C4C4C4] lg:bg-none bg-blend-lighten bg-cover bg-[#C4C4C4]/[0.9] bg-center bg-[url(./src/assets/pretty-brunette-girl-stylish-hat-posing-yellow-wall.jpg)] w-full h-[100vh] `}
      >
